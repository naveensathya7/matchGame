...
class App extends Component {
  ...
  render() {
    const {imgUrl, time, isTrue, score, category} = this.state
        ...
        <div className="game-container">
          {isTrue ? (
            ...
            <div className="game-card">
              <img className="display-image" src={imgUrl} alt="match" />
              ...
              <div className="thumbnails-container">
                <ul className="thumbnails-list">
                  {thumbnailList.map(each => (
                    <li className="thumbnail" key={each.id}>
                      <button
                        onClick={() => this.clickImage(each.thumbnailUrl)}
                        type="button"
